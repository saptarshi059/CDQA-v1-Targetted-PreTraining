...
#SBATCH --job-name="wiki FT radqa"  # A nice readable name of your job, to see it in the queue, instead of numbers
...
do
  ...
  --trained_model_name "bert-base-wiki" \
  --training_corpus "../../../../data/RadQA/wiki_corpus_radqa.parquet" \
  --eval_corpus "../../../../data/RadQA/RadQA_for_PPL_eval.csv" --epochs 3

  accelerate launch --main_process_port 12580 --mixed_precision fp16 \
  "../../../FineTuning_Scripts/old_code/squad_ft.py" --model_checkpoint "bert-base-wiki" \
  --trained_model_name "bert-base-wiki-squad" --squad_version2 True

  accelerate launch --main_process_port 12580 --mixed_precision fp16 "../../../FineTuning_Scripts/old_code/radqa_ft.py" \
  --model_checkpoint "bert-base-wiki-squad" --trained_model_name "bert-base-wiki-squad-radqa" \
  --dataset_location "../../../../data/RadQA/radqa-a-question-answering-dataset-to-improve-comprehension-of-radiology-reports-1.0.0/"

  python "../../zeroshot.py" --model_checkpoint "bert-base-wiki-squad-radqa" --dataset_location "local"
