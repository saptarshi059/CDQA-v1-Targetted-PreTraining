...
#SBATCH --job-name="fancy_normal_combined_filtered"  # A nice readable name of your job, to see it in the queue, instead of numbers
...
do
  ...
  accelerate launch --main_process_port 12581 --mixed_precision fp16 \
  "../../../FineTuning_Scripts/old_code/squad_ft.py" --model_checkpoint "bert-base-fancy_normal_combined_filtered" \
  --trained_model_name "bert-base-fancy_normal_combined_filtered-squad" --squad_version2 True

  accelerate launch --main_process_port 12581 --mixed_precision fp16 "../../../FineTuning_Scripts/old_code/radqa_ft.py" \
  --model_checkpoint "bert-base-fancy_normal_combined_filtered-squad" --trained_model_name "bert-base-fancy_normal_combined_filtered-squad-radqa" \
  --dataset_location "../../../../data/RadQA/radqa-a-question-answering-dataset-to-improve-comprehension-of-radiology-reports-1.0.0/"

  python "../../zeroshot.py" --model_checkpoint "bert-base-fancy_normal_combined_filtered-squad-radqa" --dataset_location "local"

  python "../../eval.py" --pred_file "bert-base-fancy_normal_combined_filtered-squad-radqa_radqa_predictions.pkl" --metric "squad_v2"
