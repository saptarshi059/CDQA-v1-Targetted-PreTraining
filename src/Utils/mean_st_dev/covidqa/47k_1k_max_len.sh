...
do
   accelerate launch --main_process_port 12547 --mixed_precision fp16 "../../../FineTuning_Scripts/Fine-Tuning_for_MLM.py" \
   ...
   accelerate launch --main_process_port 12547 --mixed_precision fp16 "../../../FineTuning_Scripts/old_code/squad_ft.py" \
   --model_checkpoint bert-base-47k_1k_max_len --trained_model_name bert-base-47k_1k_max_len-squad --squad_version2 False

   accelerate launch --main_process_port 12547 --mixed_precision fp16 "../../../FineTuning_Scripts/old_code/covidqa_ft.py" \
