...
do
   accelerate launch --main_process_port 12587 --mixed_precision fp16 "../../../FineTuning_Scripts/Fine-Tuning_for_MLM.py" \
   ...
   accelerate launch --main_process_port 12587 --mixed_precision fp16 "../../../FineTuning_Scripts/old_code/squad_ft.py" \
   --model_checkpoint bert-base-wiki --trained_model_name bert-base-wiki-squad --squad_version2 False

   accelerate launch --main_process_port 12587 --mixed_precision fp16 "../../../FineTuning_Scripts/old_code/covidqa_ft.py" \
