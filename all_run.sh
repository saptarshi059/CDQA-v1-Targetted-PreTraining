...
#accelerate launch src/FineTuning_Scripts/Fine-Tuning_for_MLM.py --model_checkpoint distilbert-base-uncased --trained_model_name distilbert-base-uncased-extended-PT-wo-new-tokens-mini_corpus-10T5CpT --corpus_file data/our-wikipedia-corpus/Tokens_From_Question_side/mini_corpus-10T5CpT.csv --use_new_tokens False
...
accelerate launch --main_process_port 80 src/FineTuning_Scripts/covidqa_ft.py --model_checkpoint distilbert-base-uncased-extended-PT-wo-new-tokens-mini_corpus-10T5CpT-squad --trained_model_name distilbert-base-uncased-extended-PT-wo-new-tokens-mini_corpus-10T5CpT-squad-covidqa
